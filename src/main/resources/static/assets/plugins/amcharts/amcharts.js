        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0; else {
                var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, n = 1, p = 0,
                    r = Math.round((this.max - this.min) / this.step) + 1, u;
...
AmCharts.RecAxis = AmCharts.Class({
    construct: function (a) {
        var b = a.chart, c = a.axisThickness, d = a.axisColor, e = a.axisAlpha, f = a.offset, g = a.dx, h = a.dy, k = a.viX, l = a.viY,
            m = a.viH, n = a.viW, p = b.container;
...
AmCharts.RecItem = AmCharts.Class({
    construct: function (a, b, c, d, e, f, g, h, k, l) {
        ...
        this.set = u;
        var q = a.axisThickness, t = a.axisColor, v = a.axisAlpha, s = a.tickLength, w = a.gridAlpha, A = a.gridThickness, C = a.gridColor,
            y = a.dashLength, z = a.fillColor, J = a.fillAlpha, I = a.labelsEnabled, B = a.labelRotation, Z = a.counter, S = a.inside,
...
AmCharts.AmChart = AmCharts.Class({
    construct: function (a) {
        ...
        this.prefixesOfBigNumbers = [{number: 1E3, prefix: "k"}, {number: 1E6, prefix: "M"}, {number: 1E9, prefix: "G"}, {
            number: 1E12,
            prefix: "T"
        }, {number: 1E15, prefix: "P"}, {number: 1E18, prefix: "E"}, {number: 1E21, prefix: "Z"}, {number: 1E24, prefix: "Y"}];
        ...
        var f = AmCharts.removePx(AmCharts.getStyle(a, "padding-left")), g = AmCharts.removePx(AmCharts.getStyle(a, "padding-right")),
            h = AmCharts.removePx(AmCharts.getStyle(a, "padding-top")), k = AmCharts.removePx(AmCharts.getStyle(a, "padding-bottom"));
        isNaN(f) || (c -= f);
        isNaN(g) || (c -= g);
        isNaN(h) || (d -= h);
        isNaN(k) || (d -= k);
        ...
        if (this.container) {
            var b = a.y, c = a.text, d = a.align, e = a.size, f = a.color, g = a.rotation, h = a.alpha, k = a.bold,
    ...
    clearLabels: function () {
        ...
        if ("amcharts.com" != b) {
            ...
            var f =
                "http://www.amcharts.com/javascript-charts/", g = "JavaScript charts", h = "";
...
AmCharts.AmGraph = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this.chart, b = this.id, c = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type,
            h = this.columnWidthReal;
        isNaN(this.columnWidth) || (h = this.columnWidth);
        isNaN(h) && (h = 0.8);
        var k = this.width, l = this.height, m = this.y, n = this.rotate, p = this.columnCount,
            r = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), u = this.connect, q = [], t = [], v, s, w, A,
            C = this.chart.graphs.length, y, z = this.dx / this.depthCount, J = this.dy / this.depthCount, I = f.stackType,
            B = this.labelPosition, Z = this.start, S = this.end, da = this.scrollbar, X = this.categoryAxis, Fa = this.baseCoord,
            ea = this.negativeBase, $ = this.columnIndex, L = this.lineThickness, V = this.lineAlpha, oa = this.lineColorR,
            Y = this.dashLength, W = this.set, aa = B,
            ha = this.getGradRotation(), G = this.chart.columnSpacing, D = X.cellWidth, ia = (D * h - p) / p;
        G > ia && (G = ia);
        var P, x, Va, ab = l + 1, bb = k + 1, Wa = 0, cb = 0, db, eb, Xa, Ya, Kb = this.fillColorsR, Ka = this.negativeFillColors,
            Aa = this.negativeLineColor, La = this.fillAlphas, Ma = this.negativeFillAlphas;
        ...
        for (H = Z; H <= S; H++) {
            ...
            x.index = H;
            var M, N, K, ba, ja = NaN, F = NaN, E = NaN, Q = NaN, O = NaN, Oa = NaN, Ba = NaN, Pa = NaN, Ca = NaN, ca = NaN, ga = NaN,
                pa = NaN, qa = NaN, R = NaN, fb = NaN, gb = NaN, la = NaN, na = void 0, za = Kb, Qa = La, ra = oa, ma, sa,
                Ra = this.pattern;
                    ...
                    case "ohlc":
                        if (!(isNaN(la) || isNaN(fb) || isNaN(gb) || isNaN(R))) {
                            ...
                            if (n) {
                                ...
                                var sb = F - h / 2, sb = AmCharts.fitToBounds(sb, 0, k), Ab = AmCharts.fitToBounds(F, 0, k), tb = F + h / 2,
        ...
        if (1 < a.length) {
            ...
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n =
                    this.lineColorR, p = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, q = this.negativeFillAlphas,
                t = this.baseCoord, v = this.lineColorSwitched;
            v && (n = v);
...
AmCharts.ChartCursor = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = c.position, e = c.inside, f = c.axisThickness,
            g = this.categoryBalloon, h, k, l = a.dx, m = a.dy, n = this.x, p = this.y, r = this.width, u = this.height, a = a.rotate,
            q = c.tickLength;
        g.pointerWidth = q;
        ...
        var a = this.chart, b = a.mouseX - this.x, c = a.mouseY - this.y, d = this.vLine, e = this.hLine,
        ...
        if (this.enabled) {
            ...
            if (p) {
                var r = p.x[f.id], u = c.rotate, q = f.inside, t = this.stepWidth, v = this.categoryBalloon,
                    s = this.firstTime, w = this.lastTime, A = this.cursorPosition, C = f.position, y = this.zooming, z = this.panning,
                    J = c.graphs, I = f.axisThickness;
                if (c.mouseIsOver || y || z || this.forceShow) if (this.forceShow = !1, z) {
                    var g = this.panClickPos, c = this.panClickEndTime, y = this.panClickStartTime, B = this.panClickEnd,
                        k = this.panClickStart, d = (u ? g - e : g - d) / t;
...
AmCharts.ChartScrollbar = AmCharts.Class({
    inherits: AmCharts.SimpleChartScrollbar, construct: function (a) {
        ...
        var b = a.chart, c = b.chartData, d = a.categoryAxis, e = a.rotate, f = a.x, g = a.y, h = a.width, k = a.height, l = b.categoryAxis,
            m = a.set;
        d.setOrientation(!e);
    ...
    construct: function (a) {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                var u = this.horizontalPadding, q = this.verticalPadding, t = this.pointerWidth, v = this.pointerOrientation,
                    s = this.cornerRadius, w = c.fontFamily, A = this.fontSize;
    ...
    animateAgain: function () {
        ...
        for (c = 0; c < a.length; c++) {
            var d = this.formatString(this.labelText, a[c]),
                d = AmCharts.text(this.container, d, this.color, this.fontFamily, this.fontSize), e = d.getBBox().width;
            e > b && (b = e);
            d.remove()
        }
        return b
...
AmCharts.AmRectangularChart = AmCharts.Class({
    inherits: AmCharts.AmCoordinateChart, construct: function (a) {
        ...
        var a = this.valueAxes, b, c = this.autoMarginOffset, d = this.fixMargins, e = this.realWidth, f = this.realHeight, g = c, h = c,
            k = e - c;
        b = f - c;
        var l;
        ...
        var c = a.color, d = a.fontSize, e = a.zoomOutButtonImageSize, f = a.zoomOutButtonImage, g = a.zoomOutText,
            h = a.zoomOutButtonColor, k = a.zoomOutButtonAlpha, l = a.zoomOutButtonFontSize, m = a.zoomOutButtonPadding;
        isNaN(l) || (d = l);
    ...
    zoomOut: function () {
        ...
        var a = this.dx, b = this.dy, c = this.marginLeftReal, d = this.marginTopReal, e = this.plotAreaWidth - 1,
            f = this.plotAreaHeight - 1, g = this.plotAreaFillColors, h = this.plotAreaFillAlphas, k = this.plotAreaBorderColor,
...
AmCharts.TrendLine = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this;
        a.destroy();
        var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate,
            n = a.finalCategory, p = a.valueAxis, r = a.valueAxisX, u = a.initialXValue, q = a.finalXValue, t = a.initialValue,
            v = a.finalValue,
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < q && (q = 359.94);
    e >= q && (e = q);
    var t = 1 / 180 * Math.PI, q = b + Math.sin(d * t) * h, v = c - Math.cos(d * t) * r, s = b + Math.sin(d * t) * f,
        w = c - Math.cos(d * t) * g, A = b + Math.sin((d + e) * t) * f, C = c - Math.cos((d + e) * t) * g,
        y = b + Math.sin((d + e) * t) * h, t = c - Math.cos((d + e) * t) * r,
        z = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, J = 0;
    180 < Math.abs(e) && (J = 1);
    d = a.set();
    var I;
...
AmCharts.Bezier = AmCharts.Class({
    ...
    interpolate: function (a) {
        ...
        var e = Math.round, f = this.getPointOnSegment(a, b, 0.75), g = this.getPointOnSegment(d, c, 0.75), h = (d.x - a.x) / 16,
            k = (d.y - a.y) / 16, l = this.getPointOnSegment(a, b, 0.375);
...
AmCharts.AmLegend = AmCharts.Class({
    construct: function (a) {
        ...
        var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom,
            f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing,
            n = h - c - b, p = 0, r = 0, u = this.container, q = u.set();
        this.set = q;
        u = u.set();
        q.push(u);
...
AmCharts.stringToDate = function (a, b) {
    var c = {}, d = [{pattern: "YYYY", period: "year"}, {pattern: "YY", period: "year"}, {pattern: "MM", period: "month"}, {
        pattern: "M",
        period: "month"
    }, {pattern: "DD", period: "date"}, {pattern: "D", period: "date"}, {pattern: "JJ", period: "hours"}, {
        pattern: "J",
        period: "hours"
    }, {pattern: "HH", period: "hours"}, {pattern: "H", period: "hours"}, {pattern: "KK", period: "hours"}, {
        pattern: "K",
        period: "hours"
    }, {pattern: "LL", period: "hours"}, {pattern: "L", period: "hours"}, {pattern: "NN", period: "minutes"}, {
        pattern: "N",
        period: "minutes"
    }, {pattern: "SS", period: "seconds"}, {pattern: "S", period: "seconds"}, {pattern: "QQQ", period: "milliseconds"}, {
        pattern: "QQ",
        period: "milliseconds"
    }, {pattern: "Q", period: "milliseconds"}], e = !0, f = b.indexOf("AA");
