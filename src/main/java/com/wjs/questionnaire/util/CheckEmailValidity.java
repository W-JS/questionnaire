...
public class CheckEmailValidity {
    private static final Logger logger = LoggerFactory.getLogger(CheckEmailValidity.class);
    ...
    public static boolean isEmailValid(String email) {
        ...
        try {
            ...
            String emailPrefix = "wanjinshengwjs";
    ...
    public static void main(String[] args) {
        System.out.println(isEmailValid("wanjinshengwjs@163.com"));
    }
}